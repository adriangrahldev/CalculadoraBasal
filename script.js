...
function calcular(button) {
  ...
  if (peso > 0) {
    if (peso <= 30) {
      ...
      resultadoDiv.innerHTML = "<p>Vol. diario:  <span>" + vol_diario + "cc</span></p>";
      ...
      resultadoDiv.innerHTML = "<p>SC * 1500:  <span>"+sc_1500 +"cc (" + vd_1500 + " cc/hr)</span></p>";
      resultadoDiv.innerHTML += "<p>SC * 2000:  <span>"+sc_2000 +"cc (" + vd_2000 + " cc/hr)</span></p>";
    }
  } else {
